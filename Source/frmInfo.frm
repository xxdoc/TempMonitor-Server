...
Private Sub Form_Load()
    ...
    AD.LoadFormData Me
    LbInfo(0).Caption = AD.Folders(App_Folders_Database)
    LbInfo(1).Caption = AD.Folders(App_Folders_Backup)
...
Private Function BackupDate() As String
    ...
    Dim DT As Date
    On Error GoTo ErrHandler
    BackupName = AD.Folders(App_Folders_Backup) & "\" & Prog.DatabaseName & ".mdb"
